    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
				...
				<li><a href="list.php"> Solutions</a></li>
							...
							<form role="form" action="add.php" method="post">
                                <div class="box-body">
									<div class="form-group">
                                        ...
                                        <input class="form-control" id="issue" name="issue" placeholder="Enter Issue" value="<?php echo $issue; ?>" />
                                    </div> 
									<div class="form-group">
                                        <label for="exampleInputEmail1">Solution</label>
                                        <textarea cols="3" class="form-control" id="solution" name="solution"><?php echo $solution; ?></textarea>
                                    </div> 
                                </div><!-- /.box-body -->
