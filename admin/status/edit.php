    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
				...
				<li><a href="list.php">Blog Status</a></li>
							...
							<form role="form" action="edit.php?id=<?php echo $_GET['id']; ?>" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Enter Blog Status Name</label>
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter Blog Status Name" value="<?php echo $name; ?>">
                                    </div>   
                                </div><!-- /.box-body -->
